...
class TestTimeUnit(unittest.TestCase):
    ...
    def test_parse_constructor(self):
        ...
        self.assertEqual(units.Time(' 45.7 hour ').raw_value,
                         45.7 * 3600)
        self.assertEqual(units.Time(' 45.7 min ').raw_value,
                         45.7 * 60)
        self.assertEqual(units.Time(' 45.7 day').raw_value,
                         45.7 * (3600 * 24))
        self.assertEqual(units.Time(' 45.7 week').raw_value,
                         45.7 * (3600 * 24 * 7))
    ...
    def test_optimal_scale(self):
        self.assertEqual(units.Time('0 ms').optimal_scale(),
                         (0, 'sec'))
        self.assertEqual(units.Time('47 ms').optimal_scale(),
                         (47, 'ms'))
        self.assertEqual(units.Time('4334 ms').optimal_scale(),
                         (4334.0 * 0.001, 'sec'))
        self.assertEqual(units.Time('1 hour').optimal_scale(),
                         (1, 'hour'))
        self.assertEqual(units.Time('1 day').optimal_scale(),
                         (1, 'day'))
        self.assertEqual(units.Time('1.22 day').optimal_scale(),
                         (1.22, 'day'))
        self.assertEqual(units.Time('0.96 day').optimal_scale(),
                         (24 * 0.96, 'hour'))
...
class TestBitRateUnit(unittest.TestCase):
    ...
    def test_parse_constructor(self):
        ...
        self.assertEqual(units.BitRate('2.2 bits/s').raw_value,
                         2.2)
        self.assertEqual(units.BitRate('3.3 bit/s').raw_value,
                         3.3)
        self.assertEqual(units.BitRate('4.4 bps').raw_value,
                         4.4)
        self.assertEqual(units.BitRate('1.4 Gbit/s').raw_value,
                         1.4 * (10 ** 9))
        self.assertEqual(units.BitRate('1.5 Gbits/s').raw_value,
                         1.5 * (10 ** 9))
        self.assertEqual(units.BitRate('1.6 Gbps').raw_value,
                         1.6 * (10 ** 9))
        self.assertEqual(units.BitRate('1.4 Mbit/s').raw_value,
                         1.4 * (10 ** 6))
        self.assertEqual(units.BitRate('1.5 Mbits/s').raw_value,
                         1.5 * (10 ** 6))
        self.assertEqual(units.BitRate('1.6 Mbps').raw_value,
                         1.6 * (10 ** 6))
        self.assertEqual(units.BitRate('1.4 Kbit/s').raw_value,
                         1.4 * (10 ** 3))
        self.assertEqual(units.BitRate('1.5 Kbits/s').raw_value,
                         1.5 * (10 ** 3))
        self.assertEqual(units.BitRate('1.6 Kbps').raw_value,
                         1.6 * (10 ** 3))
        self.assertEqual(units.BitRate('1.4 Tbit/s').raw_value,
                         1.4 * (10 ** 12))
        self.assertEqual(units.BitRate('1.5 Tbits/s').raw_value,
                         1.5 * (10 ** 12))
        self.assertEqual(units.BitRate('1.6 Tbps').raw_value,
                         1.6 * (10 ** 12))
    ...
    def test_optimal_scale(self):
        self.assertEqual(units.BitRate('0 bps').optimal_scale(),
                         (0, 'bits/s'))
        self.assertEqual(units.BitRate('100 bps').optimal_scale(),
                         (100, 'bits/s'))
        self.assertEqual(units.BitRate('1000 bps').optimal_scale(),
                         (1, 'kbit/s'))
        self.assertEqual(units.BitRate('1100 bps').optimal_scale(),
                         (1.1, 'kbit/s'))
        self.assertEqual(units.BitRate('0.00054 bps').optimal_scale(),
                         (0.00054, 'bits/s'))
        self.assertEqual(units.BitRate('1 Gbit/s').optimal_scale(),
                         (1, 'Gbit/s'))
        self.assertEqual(units.BitRate('1 Tbit/s').optimal_scale(),
                         (1, 'Tbit/s'))
...
class TestByteRate(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertEqual(units.ByteRate('10 Bps').raw_value,
                         10)
        self.assertEqual(units.ByteRate('10 kBps').raw_value,
                         10000)
        self.assertEqual(units.ByteRate('10 KBps').raw_value,
                         10000)
        self.assertEqual(units.ByteRate('10 KByte/s').raw_value,
                         10000)
        self.assertEqual(units.ByteRate('10 MBps').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.ByteRate('10 MBytes/s').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.ByteRate('10 MByte/s').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.ByteRate('10 GBps').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.ByteRate('10 GBytes/s').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.ByteRate('10 GByte/s').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.ByteRate('10 TBps').raw_value,
                         10 * (10 ** 12))
        self.assertEqual(units.ByteRate('10 TBytes/s').raw_value,
                         10 * (10 ** 12))
        self.assertEqual(units.ByteRate('10 TByte/s').raw_value,
                         10 * (10 ** 12))
...
class TestByte(unittest.TestCase):
    ...
    def test_constructor(self):
        self.assertEqual(units.Byte('1').raw_value,
                         1)
        self.assertEqual(units.Byte('10 B').raw_value,
                         10)
        self.assertEqual(units.Byte('10 KBytes').raw_value,
                         10000)
        self.assertEqual(units.Byte('10 Kbyte').raw_value,
                         10000)
        self.assertEqual(units.Byte('10 kbyte').raw_value,
                         10000)
        self.assertEqual(units.Byte('10 KB').raw_value,
                         10000)
        self.assertEqual(units.Byte('10 KByte').raw_value,
                         10000)
        self.assertEqual(units.Byte('10 MB').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.Byte('10 MBytes').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.Byte('10 MByte').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.Byte('10 Mbyte').raw_value,
                         10 * (10 ** 6))
        self.assertEqual(units.Byte('10 GB').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.Byte('10 GBytes').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.Byte('10 GByte').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.Byte('10 Gbyte').raw_value,
                         10 * (10 ** 9))
        self.assertEqual(units.Byte('10 TB').raw_value,
                         10 * (10 ** 12))
        self.assertEqual(units.Byte('10 TBytes').raw_value,
                         10 * (10 ** 12))
        self.assertEqual(units.Byte('10 TByte').raw_value,
                         10 * (10 ** 12))
        self.assertEqual(units.Byte('10 Tbyte').raw_value,
                         10 * (10 ** 12))
